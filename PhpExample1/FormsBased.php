...
<body style="background-color:#000000">
    ...
    <script type="text/javascript">
        ...
        function cityChanged(canvasid, windowid, index) {
            invokeServerSideFunction('http://114.143.28.50/PhpExample1/AjaxEx2.php', 'onSelectCityChanged', canvasid, windowid, function () { 
        ...
        function selectMovieTime(canvasid, windowid) {
            ...
            labelWindowIDS.push(createTextBox(elemId, 'numTicketsTextBox', 800, 220, 50, 30, highestDepth, 'No.', '#F0F0F0', 12, '12pt Ariel', '#051329', 12, '12pt Ariel', 2, '[0-9]', 0, null, 1, '#2e3642',
        ...
        function showMoviesForCinema(params) {
            ...
            for (var i = 0; i < params.length; i++) {
                ...
                for (var j = 1; j < params[i].length; j++) {
                    labelWindowIDS.push(createLabel(elemId, 'MovieTimeLabel' + j.toString() + 'Poster' + i.toString(), 10 + xoffset + timesoffset, 510, 50, 20, params[i][j], '#cdc833', 
        ...
        function form1() {
            ...
            selecteCinemaWindowID = createComboBox(elemId, 'selectCinemaComboBox', 400, 220, 200, 30, highestDepth, ['Select a city first'], null, null, null, null, null, '#131aa3', 16, '16pt Ariel', '#131aa3', 16, '16pt Ariel', onSelectCinema);
