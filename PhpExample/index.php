...
<html>
    ...
    <script type="text/javascript">
        ...
        function cityChanged(canvasid, windowid, index) {
            invokeServerSideFunction('ajax.php', 'onSelectCityChanged', canvasid, windowid, function () { 
        ...
        function onSelectCinema(canvasid, windowid, index) {
            invokeServerSideFunction('ajax.php', 'onSelectCinemaChanged', canvasid, windowid, showMoviesForCinema, new Array());
        }
        function selectMovieTime(canvasid, windowid) {
            ...
            labelWindowIDS.push(createButton(elemId, 'PaymentButton', 875, 220, 100, 30, 'Book Tickets', '#0000FF', 12, '12pt Ariel', 2, highestDepth, 1, 1,
                function (canvasid, windowid) {
                    invokeServerSideFunction('ajax.php', 'DoPaymentForTickets', elemId, windowid, afterPayment, new Array());
        ...
        var windowid = form1();
        invokeServerSideFunction('ajax.php', 'InitializeForm1', elemId, windowid, null, new Array());
        invalidateRect(elemId, null, 0, 0, 1024, 768);
    </script>
    </body>
</html>
