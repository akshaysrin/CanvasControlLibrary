<%-- 
    Document   : index
    Created on : Sep 28, 2013, 8:54:26 AM
    Author     : Gilgamesh
--%>
...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            createButton(elemId, 'b8', 500, 74, 250, 56, 'Custom Click Function', '#0000FF', 12, '12pt Ariel', 7, highestDepth, 2, 1,
                function (canvasid, windowid) {
                    invokeServerSideFunction('ajax.jsp', 'ClickMe', elemId, windowid, function (params) { alert(params); }, ['test1', 'test2']);
        ...
        <%= CanvasControlLibrary.StartSession() %>
        </div>
    </body>
</html>
