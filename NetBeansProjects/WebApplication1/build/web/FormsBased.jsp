<%-- 
    Document   : FormsBased
    Created on : Sep 28, 2013, 10:28:19 AM
    Author     : Gilgamesh
--%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function cityChanged(canvasid, windowid, index) {
            invokeServerSideFunction('ajax.jsp', 'onSelectCityChanged', canvasid, windowid, function () { 
        ...
        var windowid = form1();
        invokeServerSideFunction('ajax.jsp', 'InitializeForm1', elemId, windowid, null, new Array());
        invalidateRect(elemId, null, 0, 0, 1024, 768);
    </script>
    </body>
</html>
