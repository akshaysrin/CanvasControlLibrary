...
function registerCanvasElementId(canvasId) {
    ...
    canvas.onclick = function () { canvasOnClick(canvasId); };
    canvas.ondblclick = function () { canvasOnDblClick(canvasId); };
    canvas.ondrag = function () { canvasOnDrag(canvasId); };
    canvas.ondragend = function () { canvasOnDragEnd(canvasId); };
    canvas.ondragenter = function () { canvasOnDragEnter(canvasId); };
    canvas.ondragleave = function () { canvasOnDragLeave(canvasId); };
    canvas.ondragover = function () { canvasOnDragOver(canvasId); };
    canvas.ondragstart = function () { canvasOnDragStart(canvasId); };
    canvas.ondrop = function () { canvasOnDrop(canvasId); };
    canvas.onmousedown = function () { canvasOnMouseDown(canvasId); };
    canvas.onmousemove = function () { canvasOnMouseMove(canvasId); };
    canvas.onmouseout = function () { canvasOnMouseOut(canvasId); };
    canvas.onmouseover = function () { canvasOnMouseOver(canvasId); };
    canvas.onmouseup = function () { canvasOnMouseUp(canvasId); };
    canvas.onmousewheel = function () { canvasOnMouseWheel(canvasId); };
    canvas.onscroll = function () { canvasOnScroll(canvasId); };
}
